...
// {
//         constructor(type, name, legs, tail)
//         {
//                 super(type)
//                 this.name = name;
//                 this.legs = legs;
...
// {
//         constructor(type, name, legs, tail, location)
//         {
//                 super(type, name, legs, tail)
//                 this.location = location;
//         }
// }

// let _WhiteLion = new WhiteLion("Carnivour", "Simba", 4, true, "Siberia");

// alert(_WhiteLion.type);